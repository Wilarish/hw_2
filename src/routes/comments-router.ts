...
CommentsRouter.put('/:id/like-status',authBearer,InputValidationComments.putRateComment,errorsCheckingForStatus400, commentsController.rateComment.bind(commentsController))
